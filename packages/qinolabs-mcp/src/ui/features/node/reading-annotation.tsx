...
/**
 * Reading annotation — subtle, collapsible by default.
 * Readings are interpretations of content, meant to be referenced but not demanding attention.
 */
function ReadingAnnotation({ annotation }: ReadingAnnotationProps) {
